...
from utils import (prepare_dataframe_tris, prepare_dataframe_melate_retro, get_numbers_probability_per_column,
                   get_numbers_probability)
...
if __name__ == "__main__":
    ...
    if args.type:
        if args.type == 'tris':
            ...
            if args.all_columns:
                print(json.dumps(get_numbers_probability(df), indent=2, default=int))
            else:
                print(json.dumps(get_numbers_probability_per_column(df), indent=2, default=int))
